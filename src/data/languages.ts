...
export const languages = {
  en: {
    ...
    more: "more",
    whatsapp: "WhatsApp",
    whatsappMessage: "Good morning, I am interested in discovering something more about zerox",
  ...
  it: {
    ...
    more: "scopri di più",
    whatsapp: "WhatsApp",
    whatsappMessage: "Buongiorno, sono interessato nello scoprire qualche cosa in più riguardo a zerox",
    ...
    consentError: "Accetta l'informativa sulla privacy per continuare",
  ...
  es: {
    ...
    more: "más",
    whatsapp: "WhatsApp",
    whatsappMessage: "Buenos días, estoy interesado en descubrir algo más sobre zerox",
    ...
    consentError: "Por favor, acepta la política de privacidad para continuar",
