  ...
  .crt-interference {
    ...
    background:
      linear-gradient(
        ...
        transparent 0%,
        transparent 2.1%,
        rgba(0, 255, 153, 0.18) 2.15%,
        rgba(0, 255, 153, 0.24) 2.3%,
        rgba(0, 255, 153, 0.16) 2.5%,
        transparent 2.8%,
        transparent 5.8%,
        ...
        transparent 19.3%,
        transparent 22.6%,
        rgba(0, 255, 153, 0.22) 22.65%,
        rgba(0, 255, 153, 0.30) 22.85%,
        rgba(0, 255, 153, 0.18) 23.1%,
        transparent 23.4%,
        transparent 28.4%,
        ...
        transparent 43.45%,
        transparent 48.7%,
        rgba(0, 255, 153, 0.16) 48.75%,
        rgba(0, 255, 153, 0.22) 48.9%,
        rgba(0, 255, 153, 0.13) 49.1%,
        transparent 49.4%,
        transparent 54.1%,
        ...
        transparent 60.1%,
        transparent 64.6%,
        rgba(0, 255, 153, 0.14) 64.65%,
        rgba(0, 255, 153, 0.18) 64.8%,
        rgba(0, 255, 153, 0.11) 65.0%,
        transparent 65.2%,
        transparent 70.3%,
        rgba(255, 255, 255, 0.05) 70.35%,
        transparent 70.55%,
        transparent 76.1%,
        rgba(0, 255, 153, 0.24) 76.15%,
        rgba(0, 255, 153, 0.32) 76.35%,
        rgba(0, 255, 153, 0.20) 76.55%,
        transparent 76.8%,
        transparent 81.8%,
