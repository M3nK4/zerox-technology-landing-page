  ...
  .crt-interference {
    ...
    background:
      linear-gradient(
        ...
        transparent 0%,
        transparent 2.1%,
        rgba(0, 255, 153, 0.14) 2.15%,
        rgba(0, 255, 153, 0.18) 2.3%,
        rgba(0, 255, 153, 0.12) 2.5%,
        transparent 2.8%,
        transparent 5.8%,
        rgba(255, 255, 255, 0.025) 5.85%,
        rgba(255, 255, 255, 0.03) 5.95%,
        transparent 6.1%,
        transparent 9.3%,
        rgba(255, 255, 255, 0.05) 9.35%,
        rgba(255, 255, 255, 0.07) 9.5%,
        rgba(255, 255, 255, 0.04) 9.7%,
        transparent 10.0%,
        transparent 14.7%,
        rgba(0, 255, 153, 0.08) 14.75%,
        rgba(0, 255, 153, 0.10) 14.85%,
        rgba(0, 255, 153, 0.06) 15.0%,
        transparent 15.2%,
        transparent 19.1%,
        rgba(255, 255, 255, 0.02) 19.15%,
        transparent 19.3%,
        transparent 22.6%,
        rgba(0, 255, 153, 0.16) 22.65%,
        rgba(0, 255, 153, 0.22) 22.85%,
        rgba(0, 255, 153, 0.14) 23.1%,
        transparent 23.4%,
        transparent 28.4%,
        rgba(255, 255, 255, 0.03) 28.45%,
        transparent 28.6%,
        transparent 33.3%,
        rgba(255, 255, 255, 0.06) 33.35%,
        rgba(255, 255, 255, 0.08) 33.5%,
        rgba(255, 255, 255, 0.04) 33.7%,
        transparent 33.9%,
        transparent 37.8%,
        rgba(0, 255, 153, 0.06) 37.85%,
        rgba(0, 255, 153, 0.08) 37.95%,
        rgba(0, 255, 153, 0.04) 38.1%,
        transparent 38.3%,
        transparent 43.2%,
        rgba(255, 255, 255, 0.025) 43.25%,
        transparent 43.45%,
        transparent 48.7%,
        rgba(0, 255, 153, 0.12) 48.75%,
        rgba(0, 255, 153, 0.16) 48.9%,
        rgba(0, 255, 153, 0.10) 49.1%,
        transparent 49.4%,
        transparent 54.1%,
        rgba(255, 255, 255, 0.04) 54.15%,
        rgba(255, 255, 255, 0.06) 54.25%,
        transparent 54.4%,
        transparent 59.9%,
        rgba(255, 255, 255, 0.02) 59.95%,
        transparent 60.1%,
        transparent 64.6%,
        rgba(0, 255, 153, 0.10) 64.65%,
        rgba(0, 255, 153, 0.14) 64.8%,
        rgba(0, 255, 153, 0.08) 65.0%,
        transparent 65.2%,
        transparent 70.3%,
        rgba(255, 255, 255, 0.03) 70.35%,
        transparent 70.55%,
        transparent 76.1%,
        rgba(0, 255, 153, 0.18) 76.15%,
        rgba(0, 255, 153, 0.24) 76.35%,
        rgba(0, 255, 153, 0.15) 76.55%,
        transparent 76.8%,
        transparent 81.8%,
        rgba(255, 255, 255, 0.05) 81.85%,
        rgba(255, 255, 255, 0.07) 81.95%,
        transparent 82.1%,
        transparent 87.4%,
        rgba(0, 255, 153, 0.06) 87.45%,
        rgba(0, 255, 153, 0.08) 87.55%,
        transparent 87.75%,
        transparent 93.2%,
        rgba(255, 255, 255, 0.02) 93.25%,
        transparent 93.45%,
        transparent 100%
      );
